...
for i = 1:maxSteps
    ...
    maxOfMarginalsGibbsDecode = UGM_Decode_MaxOfMarginals(nodePot,edgePot, ...
      edgeStruct, @UGM_Infer_Sample, ...
      @(nodePot, edgePot, edgeStruct, v) (samplesBlockGibbs(:, ...
                                            1:edgeStruct.maxIter)) ...
      ,burnIn);
