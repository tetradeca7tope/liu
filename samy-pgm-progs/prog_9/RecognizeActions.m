...
function [accuracy, predicted_labels, HMM_Model] = RecognizeActions(datasetTrain, datasetTest, G, maxIter)
...
num_vars = size(G, 1);
class_priors = zeros(num_classes, 1);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
for i = 1:num_classes
  HMM_Model(i) = EM_HMM(datasetTrain(i).actionData, ...
                        datasetTrain(i).poseData, ...
                        G, ...
                        datasetTrain(i).InitialClassProb, ...
                        datasetTrain(i).InitialPairProb, ...
                        maxIter);
  class_priors(i) = numel(datasetTrain(i).actionData);
end
...
function test_logls = EstimateProbs(P, actionData, poseData, G, K )
