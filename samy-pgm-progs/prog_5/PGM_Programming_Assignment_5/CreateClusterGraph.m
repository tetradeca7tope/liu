...
num_factors = numel(F);
P.clusterList = F;
P.edges = zeros(num_factors, num_factors);
% First find the number of singleton clusters
num_singleton_clusters = max([F.var]);

for i = (num_singleton_clusters+1):num_factors
