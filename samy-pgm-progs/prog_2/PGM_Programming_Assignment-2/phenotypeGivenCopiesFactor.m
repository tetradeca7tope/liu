...
phenotypeFactor = struct(...
  'var', [phenotypeVar, geneCopyVarOne, geneCopyVarTwo], ...
  'card', [2, numAlleles, numAlleles], ...
  'val', []);

prob_pheno_positive = alphaList(allelesToGenotypes(:));
prob_pheno = [prob_pheno_positive, 1 - prob_pheno_positive]';
phenotypeFactor.val = prob_pheno(:)';
