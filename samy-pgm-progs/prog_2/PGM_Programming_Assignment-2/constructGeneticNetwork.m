...
% We shall first fill the details in with the genotype factors of the
% parents and then the genotype factors of the children given parents.
...
% First the children, given the parents
for i = 1:numPeople
