...
% Next obtain the Joint prob distribution
J = ComputeJointDistribution(F);

% Now marginalize over elements not in V
marg_elems = setdiff(J.var, V);
M = FactorMarginalization(J, marg_elems);
